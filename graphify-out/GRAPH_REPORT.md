...
## Corpus Check
- 68 files · ~35,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 631 nodes · 918 edges · 76 communities (60 shown, 16 thin omitted)
...
9. `Quick Start Guide (Docker)` - 9 edges
...
Cohesion: 0.15
Nodes (14): Machine, Set, type, type, type, properties, type, type (+6 more)

### Community 61 - "Community 61"
Cohesion: 0.21
Nodes (15): $ref, definitions, $ref, anyOf, $ref, auditLog, die, machine (+7 more)
...
Cohesion: 0.14
Nodes (14): 1. Prerequisites, 2. Environment Setup, 3. Launch the Application, 4. Initialize the Database (IMPORTANT), 5. Access the App, 6. Default Login Credentials, 7. Common Commands, code:bash (cp .env.example .env) (+6 more)
...
## Knowledge Gaps
- **239 isolated node(s):** `name`, `version`, `description`, `main`, `dev` (+234 more)
